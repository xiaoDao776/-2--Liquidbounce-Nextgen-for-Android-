...
object BrowserBackendManager : EventListener {
    ...
    var isSkipping = env("LB_BROWSER_SKIP", "net.ccbluex.liquidbounce.browser.skip")?.toBoolean()
        ?: !PlatformUtils.SUPPORTS_JCEF

    val backendName = if (PlatformUtils.IS_ANDROID || PlatformUtils.IS_POJAV) {
        // Force "none" on Android/PojavLauncher since JCEF native libs don't exist
        "none"
    } else {
